...
// const trTitle = document.createElement("tr"); 
// const th = document.createElement("th"); 
// th.textContent = "Modelos"; th.colSpan = 3; 
// trTitle.appendChild(th); thead.appendChild(trTitle); 
// const cabecalho = ["Modelo", "Fabricante", "País de Origem"]; 
// const tr = document.createElement("tr"); 
// cabecalho.forEach(function(campo) { 
// const th =document.createElement("th"); 
// th.textContent = campo; tr.appendChild(th); });
...
// dados.forEach(function(item) { 
// const tr = document.createElement("tr"); 
// //modelo const tdModelo = document.createElement("td"); 
// tdModelo.textContent = item.nome; 
// tr.appendChild(tdModelo); 
// //nome do fabricante 
// const tdFabricante = document.createElement("td"); 
